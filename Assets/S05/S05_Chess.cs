...
public class S05_Chess : MonoBehaviour
{
    [SerializeField] private int canvasWidth = 256;
    [SerializeField] private int canvasHeight = 256;
    [SerializeField] private Color backgroundColor = new Color(0f, 0f, 0f, 1f); //R,G,B 모두 0, 불투명 검정
    ...
    [SerializeField] private Color colorB = new Color(0.3f, 0.6f, 0.7f, 1f); //하늘색
